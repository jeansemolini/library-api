...
public class BookControllerTest {
    ...
    @Test
    @DisplayName("Deve lançar erro de validação quando não houver dados sufiecientes para criação do livro")
    ...
    public void createBookWithDuplicatedIsbn() throws Exception {
        ...
        BDDMockito.given(service.save(Mockito.any(Book.class)))
                .willThrow(new BusinnessException(mensagemErro)); //quando o service for salvar qlq livro vai lançar BusinnessException
    ...
    public void getBookDetailsTest() throws Exception {
        ...
        BDDMockito.given(service.getById(id)).willReturn(Optional.of(book)); //quando buscar um livro com esse id(1l), vai retornar a instancia do book acima
    ...
    public void bookNotFoundTest() throws Exception {
        ...
        BDDMockito.given(service.getById(Mockito.anyLong())).willReturn(Optional.empty()); //quando buscar um livro com qualquer id, vai retornar vazio
    ...
    @Test
    @DisplayName("Deve retornar resource not found quando nao encontra um livro para deletar")
